...
public:
	 ...
	 * @version 0.1
	 */
	void Open( const char* pccFileName, const char* pccMode );
	...
	void Read( void **pvData, int iColumn, int iRow, std::string strType );
	void Read( void ***pppvData, int iColumn, int iRow, std::string strType );
...
private:
	 ...
	 * @version 0.1
	 */
	void _DataRead( void **ppvData, int iColumn, int iRow, const char *pccBuf, std::string strType );
	 ...
	 * @version 0.1
	 */
	void _DataRead( void ***pppvData, int iColumn, int iRow, const char *pccBuf, std::string strType );
